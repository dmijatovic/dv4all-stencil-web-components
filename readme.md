...
- scss/sass you need to install additional plugins from npm. Look at documention

- prettier: install pretier and [tslint config](https://alexjover.com/blog/use-prettier-with-tslint-and-be-happy/) because we use tsx files
